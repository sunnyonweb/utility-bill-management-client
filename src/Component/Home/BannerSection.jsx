...
const BannerSection = () => {
  return (
    <section className="relative overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-32 bg-base-300 dark:bg-base-200 rounded-2xl shadow-xl border border-base-300/50">
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-extrabold text-base-content leading-tight mb-4">
            Seamlessly Manage All Your{" "}
          ...
          <p className="text-lg md:text-xl text-base-content/70 mb-8 max-w-2xl mx-auto">
            Track, pay, and organize your Electricity, Gas, Water, and Internet
            bills in one secure dashboard. Stop worrying about due dates.
          </p>
          <Link
            to="/bills"
      ...
      {/* Unique Background Graphic (Semi-transparent wave effect) */}
