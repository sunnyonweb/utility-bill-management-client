...
const Navbar = () => {
  ...
  // ... (handleToggle and useEffect remain the same)
  ...
  return (
    <div className="shadow-md bg-base-100 border-b border-base-200">
      <div className="navbar container mx-auto px-4 py-2">
        {/* 1. LOGO / SITE NAME (LEFT SIDE) */}
        ...
        <div className="navbar-end space-x-3">
          ...
          {user ? (
            ...
            <div className="space-x-2">
              ...
              <Link
                to="/register"
                className="px-4 py-2 bg-cyan-600 text-white rounded-md hover:bg-cyan-700 transition duration-150 ease-in-out font-medium"
              >
                Register
              </Link>
            </div>
